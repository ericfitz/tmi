...
// setupNoteTestDB creates an in-memory SQLite DB with all tables needed for NoteRepository tests.
func setupNoteTestDB(t *testing.T) (*gorm.DB, *models.User, *models.ThreatModel) {
	t.Helper()
