...
func setupTestRouter() *gin.Engine {
	...
	router.GET("/threat_models/:id/diagrams/:diagram_id/metadata", notImplementedHandler)
	router.POST("/threat_models/:id/diagrams/:diagram_id/metadata", notImplementedHandler)
	router.GET("/threat_models/:id/diagrams/:diagram_id/metadata/:key", notImplementedHandler)
	router.PUT("/threat_models/:id/diagrams/:diagram_id/metadata/:key", notImplementedHandler)
	router.DELETE("/threat_models/:id/diagrams/:diagram_id/metadata/:key", notImplementedHandler)
	router.POST("/threat_models/:id/diagrams/:diagram_id/metadata/bulk", notImplementedHandler)

	// Threat Model Threats
	router.GET("/threat_models/:id/threats", notImplementedHandler)
	router.POST("/threat_models/:id/threats", notImplementedHandler)
	router.GET("/threat_models/:id/threats/:threat_id", notImplementedHandler)
	router.PUT("/threat_models/:id/threats/:threat_id", notImplementedHandler)
	router.PATCH("/threat_models/:id/threats/:threat_id", notImplementedHandler)
	router.DELETE("/threat_models/:id/threats/:threat_id", notImplementedHandler)
	router.POST("/threat_models/:id/threats/bulk", notImplementedHandler)
	router.PUT("/threat_models/:id/threats/bulk", notImplementedHandler)

	// Threat Model Threat Metadata
	router.GET("/threat_models/:id/threats/:threat_id/metadata", notImplementedHandler)
	router.POST("/threat_models/:id/threats/:threat_id/metadata", notImplementedHandler)
	router.GET("/threat_models/:id/threats/:threat_id/metadata/:key", notImplementedHandler)
	router.PUT("/threat_models/:id/threats/:threat_id/metadata/:key", notImplementedHandler)
	router.DELETE("/threat_models/:id/threats/:threat_id/metadata/:key", notImplementedHandler)
	router.POST("/threat_models/:id/threats/:threat_id/metadata/bulk", notImplementedHandler)

	// Threat Model Documents
	router.GET("/threat_models/:id/documents", notImplementedHandler)
	router.POST("/threat_models/:id/documents", notImplementedHandler)
	router.GET("/threat_models/:id/documents/:document_id", notImplementedHandler)
	router.PUT("/threat_models/:id/documents/:document_id", notImplementedHandler)
	router.DELETE("/threat_models/:id/documents/:document_id", notImplementedHandler)
	router.POST("/threat_models/:id/documents/bulk", notImplementedHandler)

	// Threat Model Document Metadata
	router.GET("/threat_models/:id/documents/:document_id/metadata", notImplementedHandler)
	router.POST("/threat_models/:id/documents/:document_id/metadata", notImplementedHandler)
	router.GET("/threat_models/:id/documents/:document_id/metadata/:key", notImplementedHandler)
	router.PUT("/threat_models/:id/documents/:document_id/metadata/:key", notImplementedHandler)
	router.DELETE("/threat_models/:id/documents/:document_id/metadata/:key", notImplementedHandler)
	router.POST("/threat_models/:id/documents/:document_id/metadata/bulk", notImplementedHandler)

	// Threat Model Sources
	router.GET("/threat_models/:id/sources", notImplementedHandler)
	router.POST("/threat_models/:id/sources", notImplementedHandler)
	router.GET("/threat_models/:id/sources/:source_id", notImplementedHandler)
	router.PUT("/threat_models/:id/sources/:source_id", notImplementedHandler)
	router.DELETE("/threat_models/:id/sources/:source_id", notImplementedHandler)
	router.POST("/threat_models/:id/sources/bulk", notImplementedHandler)

	// Threat Model Source Metadata
	router.GET("/threat_models/:id/sources/:source_id/metadata", notImplementedHandler)
	router.POST("/threat_models/:id/sources/:source_id/metadata", notImplementedHandler)
	router.GET("/threat_models/:id/sources/:source_id/metadata/:key", notImplementedHandler)
	router.PUT("/threat_models/:id/sources/:source_id/metadata/:key", notImplementedHandler)
	router.DELETE("/threat_models/:id/sources/:source_id/metadata/:key", notImplementedHandler)
	router.POST("/threat_models/:id/sources/:source_id/metadata/bulk", notImplementedHandler)

	// Batch Operations
	router.POST("/threat_models/:id/threats/batch/patch", notImplementedHandler)
	router.DELETE("/threat_models/:id/threats/batch", notImplementedHandler)
