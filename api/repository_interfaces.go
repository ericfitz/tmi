...
var (
	...
	ErrThreatModelNotFound    = fmt.Errorf("threat model: %w", dberrors.ErrNotFound)
	ErrDiagramNotFound        = fmt.Errorf("diagram: %w", dberrors.ErrNotFound)
	ErrTicketNotFound         = fmt.Errorf("ticket: %w", dberrors.ErrNotFound)
