...
run — there is no separate parse step. Query the results database directly; see the
cats plugin's `report` skill (`~/Projects/skills/cats/skills/report/SKILL.md`) for the
full schema (tables, views, worked queries):
