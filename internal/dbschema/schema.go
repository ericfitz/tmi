	...
	return []TableSchema{
		...
		},
		{
			...
			Columns: []ColumnSchema{
				...
				{Name: "subject", DataType: "character varying", IsNullable: false},
				{Name: "subject_type", DataType: "character varying", IsNullable: false},
				{Name: "idp", DataType: "character varying", IsNullable: true},
				{Name: "role", DataType: "character varying", IsNullable: false},
				{Name: "granted_by", DataType: "character varying", IsNullable: true},
				{Name: "created_at", DataType: "timestamp with time zone", IsNullable: false},
				{Name: "modified_at", DataType: "timestamp with time zone", IsNullable: false},
			},
			Indexes: []IndexSchema{
				{Name: "threat_model_access_pkey", Columns: []string{"id"}, IsUnique: true},
				{Name: "threat_model_access_threat_model_id_subject_subject_type__key", Columns: []string{"threat_model_id", "subject", "subject_type", "idp"}, IsUnique: true},
				{Name: "idx_threat_model_access_threat_model_id", Columns: []string{"threat_model_id"}, IsUnique: false},
				{Name: "idx_threat_model_access_subject", Columns: []string{"subject"}, IsUnique: false},
				{Name: "idx_threat_model_access_subject_type", Columns: []string{"subject_type"}, IsUnique: false},
				{Name: "idx_threat_model_access_idp", Columns: []string{"idp"}, IsUnique: false},
				{Name: "idx_threat_model_access_role", Columns: []string{"role"}, IsUnique: false},
				{Name: "idx_threat_model_access_performance", Columns: []string{"threat_model_id", "subject_type", "subject"}, IsUnique: false},
			},
			Constraints: []ConstraintSchema{
				{
			...
			Constraints: []ConstraintSchema{
				{
					...
					Type:       "CHECK",
					Definition: "entity_type IN ('threat_model', 'threat', 'diagram', 'document', 'repository', 'cell')",
				},
				{
