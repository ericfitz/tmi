	...
	return []TableSchema{
		...
		},
		{
			...
			Columns: []ColumnSchema{
				...
				{Name: "value", DataType: "character varying", IsNullable: false},
				{Name: "created_at", DataType: "timestamp without time zone", IsNullable: false},
				{Name: "updated_at", DataType: "timestamp without time zone", IsNullable: false},
			},
			Indexes: []IndexSchema{
			...
			Constraints: []ConstraintSchema{
				{
					...
					Type:       "CHECK",
					Definition: "entity_type IN ('threat_model', 'threat', 'diagram', 'document', 'source')",
				},
				{
					Name:       "metadata_key_not_empty",
					Type:       "CHECK",
					Definition: "LENGTH(TRIM(key)) > 0",
				},
				{
					Name:       "metadata_value_not_empty",
					Type:       "CHECK",
					Definition: "LENGTH(TRIM(value)) > 0",
				},
			},
		},
		{
