...
* <pre>
* var TmiClient = require('index'); // See note below*.
* var xxxSvc = new TmiClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new TmiClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new TmiClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new TmiClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
