...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiClient.UsersApi();
  });
    ...
    describe('UsersApi', function() {
      describe('deleteUserAccount', function() {
        it('should call deleteUserAccount successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteUserAccount call and complete the assertions
          /*
          var opts = {};

          instance.deleteUserAccount(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(TmiClient.DeletionChallenge);
