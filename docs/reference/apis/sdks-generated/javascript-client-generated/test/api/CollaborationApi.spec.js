...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiClient.CollaborationApi();
  });

  describe('(package)', function() {
    describe('CollaborationApi', function() {
      describe('createDiagramCollaborationSession', function() {
        it('should call createDiagramCollaborationSession successfully', function(done) {
          ...
          instance.createDiagramCollaborationSession(threatModelId, diagramId, function(error, data, response) {
            ...
            expect(data).to.be.a(TmiClient.CollaborationSession);
      ...
      describe('endDiagramCollaborationSession', function() {
        it('should call endDiagramCollaborationSession successfully', function(done) {
      ...
      describe('getCollaborationSessions', function() {
        it('should call getCollaborationSessions successfully', function(done) {
      ...
      describe('getDiagramCollaborationSession', function() {
        it('should call getDiagramCollaborationSession successfully', function(done) {
