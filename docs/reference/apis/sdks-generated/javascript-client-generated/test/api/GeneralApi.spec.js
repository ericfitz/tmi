...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiClient.GeneralApi();
  });
    ...
    describe('GeneralApi', function() {
      describe('getApiInfo', function() {
        it('should call getApiInfo successfully', function(done) {
          // TODO: uncomment getApiInfo call and complete the assertions
          /*

          instance.getApiInfo(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(TmiClient.ApiInfo);
