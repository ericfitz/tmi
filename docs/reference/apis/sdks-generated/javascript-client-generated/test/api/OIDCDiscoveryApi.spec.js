...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiClient.OIDCDiscoveryApi();
  });

  describe('(package)', function() {
    describe('OIDCDiscoveryApi', function() {
      describe('getJWKS', function() {
        it('should call getJWKS successfully', function(done) {
          ...
          instance.getJWKS(function(error, data, response) {
            ...
            expect(data).to.be.a(TmiClient.InlineResponse2002);
      ...
      describe('getOAuthAuthorizationServerMetadata', function() {
        it('should call getOAuthAuthorizationServerMetadata successfully', function(done) {
          ...
          instance.getOAuthAuthorizationServerMetadata(function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(TmiClient.InlineResponse2001);
      ...
      describe('getOpenIDConfiguration', function() {
        it('should call getOpenIDConfiguration successfully', function(done) {
          ...
          instance.getOpenIDConfiguration(function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(TmiClient.InlineResponse200);
