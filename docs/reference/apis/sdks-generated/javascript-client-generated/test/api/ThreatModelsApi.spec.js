...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TmiClient.ThreatModelsApi();
  });

  describe('(package)', function() {
    describe('ThreatModelsApi', function() {
      describe('createThreatModel', function() {
        it('should call createThreatModel successfully', function(done) {
          ...
          instance.createThreatModel(body, function(error, data, response) {
            ...
            expect(data).to.be.a(TmiClient.ThreatModel);
      ...
      describe('deleteThreatModel', function() {
        it('should call deleteThreatModel successfully', function(done) {
      ...
      describe('getThreatModel', function() {
        it('should call getThreatModel successfully', function(done) {
      ...
      describe('listThreatModels', function() {
        it('should call listThreatModels successfully', function(done) {
          // TODO: uncomment, update parameter values for listThreatModels call and complete the assertions
          /*
          var opts = {};
          ...
          instance.listThreatModels(opts, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(TmiClient.TMListItem);
            }
      ...
      describe('patchThreatModel', function() {
        it('should call patchThreatModel successfully', function(done) {
          // TODO: uncomment, update parameter values for patchThreatModel call and complete the assertions
          /*
          var opts = {};
      ...
      describe('updateThreatModel', function() {
        it('should call updateThreatModel successfully', function(done) {
