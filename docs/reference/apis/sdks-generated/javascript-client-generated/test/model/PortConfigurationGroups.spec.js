...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortConfigurationGroups', function() {
      beforeEach(function() {
        instance = new TmiClient.PortConfigurationGroups();
      });

      it('should create an instance of PortConfigurationGroups', function() {
        // TODO: update the code to test PortConfigurationGroups
        expect(instance).to.be.a(TmiClient.PortConfigurationGroups);
      });
