...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Error', function() {
      beforeEach(function() {
        instance = new TmiClient.Error();
      });

      it('should create an instance of Error', function() {
        // TODO: update the code to test Error
        expect(instance).to.be.a(TmiClient.Error);
      });
      ...
      it('should have the property errorUri (base name: "error_uri")', function() {
        // TODO: update the code to test the property errorUri
        expect(instance).to.have.property('errorUri');
        // expect(instance.errorUri).to.be(expectedValueLiteral);
      });
