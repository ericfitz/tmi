...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Oauth2IntrospectBody', function() {
      beforeEach(function() {
        instance = new TmiClient.Oauth2IntrospectBody();
      });

      it('should create an instance of Oauth2IntrospectBody', function() {
        // TODO: update the code to test Oauth2IntrospectBody
        expect(instance).to.be.a(TmiClient.Oauth2IntrospectBody);
      });
      ...
      it('should have the property tokenTypeHint (base name: "token_type_hint")', function() {
        // TODO: update the code to test the property tokenTypeHint
        expect(instance).to.have.property('tokenTypeHint');
        // expect(instance.tokenTypeHint).to.be(expectedValueLiteral);
      });
