...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RepositoryBase', function() {
      beforeEach(function() {
        instance = new TmiClient.RepositoryBase();
      });

      it('should create an instance of RepositoryBase', function() {
        // TODO: update the code to test RepositoryBase
        expect(instance).to.be.a(TmiClient.RepositoryBase);
      });
