...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeLabel', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeLabel();
      });

      it('should create an instance of EdgeLabel', function() {
        // TODO: update the code to test EdgeLabel
        expect(instance).to.be.a(TmiClient.EdgeLabel);
      });
