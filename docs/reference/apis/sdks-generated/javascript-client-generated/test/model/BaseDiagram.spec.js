...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseDiagram', function() {
      beforeEach(function() {
        instance = new TmiClient.BaseDiagram();
      });

      it('should create an instance of BaseDiagram', function() {
        // TODO: update the code to test BaseDiagram
        expect(instance).to.be.a(TmiClient.BaseDiagram);
      });
