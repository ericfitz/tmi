...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Oauth2RefreshBody', function() {
      beforeEach(function() {
        instance = new TmiClient.Oauth2RefreshBody();
      });

      it('should create an instance of Oauth2RefreshBody', function() {
        // TODO: update the code to test Oauth2RefreshBody
        expect(instance).to.be.a(TmiClient.Oauth2RefreshBody);
      });
