...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatModelsthreatModelIdthreatsbulkPatches', function() {
      beforeEach(function() {
        instance = new TmiClient.ThreatModelsthreatModelIdthreatsbulkPatches();
      });

      it('should create an instance of ThreatModelsthreatModelIdthreatsbulkPatches', function() {
        // TODO: update the code to test ThreatModelsthreatModelIdthreatsbulkPatches
        expect(instance).to.be.a(TmiClient.ThreatModelsthreatModelIdthreatsbulkPatches);
      });
