...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CellTool', function() {
      beforeEach(function() {
        instance = new TmiClient.CellTool();
      });

      it('should create an instance of CellTool', function() {
        // TODO: update the code to test CellTool
        expect(instance).to.be.a(TmiClient.CellTool);
      });
