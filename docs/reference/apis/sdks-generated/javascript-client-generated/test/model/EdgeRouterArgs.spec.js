...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeRouterArgs', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeRouterArgs();
      });

      it('should create an instance of EdgeRouterArgs', function() {
        // TODO: update the code to test EdgeRouterArgs
        expect(instance).to.be.a(TmiClient.EdgeRouterArgs);
      });

      it('should have the property padding (base name: "padding")', function() {
        // TODO: update the code to test the property padding
        expect(instance).to.have.property('padding');
        // expect(instance.padding).to.be(expectedValueLiteral);
      });
