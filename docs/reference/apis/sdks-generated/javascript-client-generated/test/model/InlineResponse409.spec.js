...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse409', function() {
      ...
      it('should have the property joinUrl (base name: "join_url")', function() {
        // TODO: update the code to test the property joinUrl
        expect(instance).to.have.property('joinUrl');
        // expect(instance.joinUrl).to.be(expectedValueLiteral);
      });
