...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeConnectorArgs', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeConnectorArgs();
      });

      it('should create an instance of EdgeConnectorArgs', function() {
        // TODO: update the code to test EdgeConnectorArgs
        expect(instance).to.be.a(TmiClient.EdgeConnectorArgs);
      });
      ...
      it('should have the property jump (base name: "jump")', function() {
        // TODO: update the code to test the property jump
        expect(instance).to.have.property('jump');
        // expect(instance.jump).to.be(expectedValueLiteral);
      });
