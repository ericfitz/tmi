...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodeSize', function() {
      beforeEach(function() {
        instance = new TmiClient.NodeSize();
      });

      it('should create an instance of NodeSize', function() {
        // TODO: update the code to test NodeSize
        expect(instance).to.be.a(TmiClient.NodeSize);
      });
