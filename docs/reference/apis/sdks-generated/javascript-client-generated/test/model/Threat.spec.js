...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Threat', function() {
      beforeEach(function() {
        instance = new TmiClient.Threat();
      });

      it('should create an instance of Threat', function() {
        // TODO: update the code to test Threat
        expect(instance).to.be.a(TmiClient.Threat);
      });
