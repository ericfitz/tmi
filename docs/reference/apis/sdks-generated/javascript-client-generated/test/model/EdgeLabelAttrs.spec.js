...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeLabelAttrs', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeLabelAttrs();
      });

      it('should create an instance of EdgeLabelAttrs', function() {
        // TODO: update the code to test EdgeLabelAttrs
        expect(instance).to.be.a(TmiClient.EdgeLabelAttrs);
      });
