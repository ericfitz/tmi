...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeAttrsLineTargetMarker', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeAttrsLineTargetMarker();
      });

      it('should create an instance of EdgeAttrsLineTargetMarker', function() {
        // TODO: update the code to test EdgeAttrsLineTargetMarker
        expect(instance).to.be.a(TmiClient.EdgeAttrsLineTargetMarker);
      });
