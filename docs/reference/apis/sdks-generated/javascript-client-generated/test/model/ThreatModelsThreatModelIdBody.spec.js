...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatModelsThreatModelIdBody', function() {
      beforeEach(function() {
        instance = new TmiClient.ThreatModelsThreatModelIdBody();
      });

      it('should create an instance of ThreatModelsThreatModelIdBody', function() {
        // TODO: update the code to test ThreatModelsThreatModelIdBody
        expect(instance).to.be.a(TmiClient.ThreatModelsThreatModelIdBody);
      });
