...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DfdDiagram', function() {
      beforeEach(function() {
        instance = new TmiClient.DfdDiagram();
      });

      it('should create an instance of DfdDiagram', function() {
        // TODO: update the code to test DfdDiagram
        expect(instance).to.be.a(TmiClient.DfdDiagram);
      });
