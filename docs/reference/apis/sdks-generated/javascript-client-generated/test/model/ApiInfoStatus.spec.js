...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiInfoStatus', function() {
      beforeEach(function() {
        instance = new TmiClient.ApiInfoStatus();
      });

      it('should create an instance of ApiInfoStatus', function() {
        // TODO: update the code to test ApiInfoStatus
        expect(instance).to.be.a(TmiClient.ApiInfoStatus);
      });
