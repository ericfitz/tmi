...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeAttrsLineSourceMarker', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeAttrsLineSourceMarker();
      });

      it('should create an instance of EdgeAttrsLineSourceMarker', function() {
        // TODO: update the code to test EdgeAttrsLineSourceMarker
        expect(instance).to.be.a(TmiClient.EdgeAttrsLineSourceMarker);
      });
