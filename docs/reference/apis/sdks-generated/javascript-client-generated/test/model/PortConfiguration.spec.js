...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortConfiguration', function() {
      beforeEach(function() {
        instance = new TmiClient.PortConfiguration();
      });

      it('should create an instance of PortConfiguration', function() {
        // TODO: update the code to test PortConfiguration
        expect(instance).to.be.a(TmiClient.PortConfiguration);
      });
