...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NoteBase', function() {
      beforeEach(function() {
        instance = new TmiClient.NoteBase();
      });

      it('should create an instance of NoteBase', function() {
        // TODO: update the code to test NoteBase
        expect(instance).to.be.a(TmiClient.NoteBase);
      });
