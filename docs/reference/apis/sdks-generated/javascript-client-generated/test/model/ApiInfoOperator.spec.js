...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiInfoOperator', function() {
      beforeEach(function() {
        instance = new TmiClient.ApiInfoOperator();
      });

      it('should create an instance of ApiInfoOperator', function() {
        // TODO: update the code to test ApiInfoOperator
        expect(instance).to.be.a(TmiClient.ApiInfoOperator);
      });
