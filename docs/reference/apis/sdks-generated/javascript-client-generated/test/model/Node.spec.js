  ...
  describe('(package)', function() {
    describe('Node', function() {
      ...
      it('should have the property angle (base name: "angle")', function() {
        // TODO: update the code to test the property angle
        expect(instance).to.have.property('angle');
        // expect(instance.angle).to.be(expectedValueLiteral);
      });
