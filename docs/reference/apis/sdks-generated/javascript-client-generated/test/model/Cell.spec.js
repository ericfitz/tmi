  ...
  describe('(package)', function() {
    describe('Cell', function() {
      ...
      it('should have the property zIndex (base name: "zIndex")', function() {
        // TODO: update the code to test the property zIndex
        expect(instance).to.have.property('zIndex');
        // expect(instance.zIndex).to.be(expectedValueLiteral);
      });
