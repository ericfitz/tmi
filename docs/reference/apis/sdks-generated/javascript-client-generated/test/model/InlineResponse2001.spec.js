  ...
  describe('(package)', function() {
    describe('InlineResponse2001', function() {
      ...
      it('should have the property grantTypesSupported (base name: "grant_types_supported")', function() {
        // TODO: update the code to test the property grantTypesSupported
        expect(instance).to.have.property('grantTypesSupported');
        // expect(instance.grantTypesSupported).to.be(expectedValueLiteral);
      });

      it('should have the property tokenEndpointAuthMethodsSupported (base name: "token_endpoint_auth_methods_supported")', function() {
        // TODO: update the code to test the property tokenEndpointAuthMethodsSupported
        expect(instance).to.have.property('tokenEndpointAuthMethodsSupported');
        // expect(instance.tokenEndpointAuthMethodsSupported).to.be(expectedValueLiteral);
      });
