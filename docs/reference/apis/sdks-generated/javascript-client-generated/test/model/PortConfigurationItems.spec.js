...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortConfigurationItems', function() {
      beforeEach(function() {
        instance = new TmiClient.PortConfigurationItems();
      });

      it('should create an instance of PortConfigurationItems', function() {
        // TODO: update the code to test PortConfigurationItems
        expect(instance).to.be.a(TmiClient.PortConfigurationItems);
      });
