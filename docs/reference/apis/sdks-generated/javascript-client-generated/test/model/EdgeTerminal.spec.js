...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgeTerminal', function() {
      beforeEach(function() {
        instance = new TmiClient.EdgeTerminal();
      });

      it('should create an instance of EdgeTerminal', function() {
        // TODO: update the code to test EdgeTerminal
        expect(instance).to.be.a(TmiClient.EdgeTerminal);
      });

      it('should have the property cell (base name: "cell")', function() {
        // TODO: update the code to test the property cell
        expect(instance).to.have.property('cell');
        // expect(instance.cell).to.be(expectedValueLiteral);
      });
