...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NoteListItem', function() {
      beforeEach(function() {
        instance = new TmiClient.NoteListItem();
      });

      it('should create an instance of NoteListItem', function() {
        // TODO: update the code to test NoteListItem
        expect(instance).to.be.a(TmiClient.NoteListItem);
      });
