...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsThreatIdBody', function() {
      beforeEach(function() {
        instance = new TmiClient.ThreatsThreatIdBody();
      });

      it('should create an instance of ThreatsThreatIdBody', function() {
        // TODO: update the code to test ThreatsThreatIdBody
        expect(instance).to.be.a(TmiClient.ThreatsThreatIdBody);
      });
