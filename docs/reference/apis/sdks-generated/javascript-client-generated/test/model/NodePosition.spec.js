...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodePosition', function() {
      beforeEach(function() {
        instance = new TmiClient.NodePosition();
      });

      it('should create an instance of NodePosition', function() {
        // TODO: update the code to test NodePosition
        expect(instance).to.be.a(TmiClient.NodePosition);
      });
