...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarkupElement', function() {
      beforeEach(function() {
        instance = new TmiClient.MarkupElement();
      });

      it('should create an instance of MarkupElement', function() {
        // TODO: update the code to test MarkupElement
        expect(instance).to.be.a(TmiClient.MarkupElement);
      });
