...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodeAttrs', function() {
      beforeEach(function() {
        instance = new TmiClient.NodeAttrs();
      });

      it('should create an instance of NodeAttrs', function() {
        // TODO: update the code to test NodeAttrs
        expect(instance).to.be.a(TmiClient.NodeAttrs);
      });
