 ...
 */
@Schema(description = "Image data with version information")
...
public class BaseDiagramImage {
  ...
  public BaseDiagramImage svg(byte[] svg) {
    this.svg = svg;
    return this;
  }
   ...
   * @return svg
  **/
  @Schema(description = "BASE64 encoded SVG representation of the diagram, used for thumbnails and reports")
  public byte[] getSvg() {
    return svg;
  }
  ...
  public BaseDiagramImage updateVector(Long updateVector) {
   ...
   * @return updateVector
  **/
  @Schema(description = "Version of the diagram when this SVG was generated. If not provided when svg is updated, will be auto-set to BaseDiagram.update_vector")
  public Long getUpdateVector() {
    return updateVector;
  }

  public void setUpdateVector(Long updateVector) {
    this.updateVector = updateVector;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BaseDiagramImage baseDiagramImage = (BaseDiagramImage) o;
    return Arrays.equals(this.svg, baseDiagramImage.svg) &&
        Objects.equals(this.updateVector, baseDiagramImage.updateVector);
  }

  @Override
  public int hashCode() {
    return Objects.hash(Arrays.hashCode(svg), updateVector);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseDiagramImage {\n");
