...
public class InlineResponse409 {
  ...
  public InlineResponse409 error(String error) {
    this.error = error;
    return this;
  }
   ...
   * @return error
  **/
  @Schema(required = true, description = "Error message indicating session already exists")
  ...
  public InlineResponse409 joinUrl(String joinUrl) {
   ...
   * @return joinUrl
  **/
  @Schema(example = "/threat_models/{threat_model_id}/diagrams/{diagram_id}/collaborate", required = true, description = "URL to join the existing collaboration session")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.error, inlineResponse409.error) &&
        Objects.equals(this.joinUrl, inlineResponse409.joinUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(error, joinUrl);
  }
