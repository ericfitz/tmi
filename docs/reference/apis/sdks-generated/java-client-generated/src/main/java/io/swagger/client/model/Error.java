...
public class Error {
  ...
  private ErrorDetails details = null;
  ...
  **/
  @Schema(required = true, description = "Human-readable error description")
   ...
   * @return errorUri
  **/
  @Schema(description = "URI to documentation about the error")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(error, errorDescription, errorUri, details);
  }
