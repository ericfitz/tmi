...
/**
 * API tests for OidcDiscoveryApi
 */
@Ignore
public class OidcDiscoveryApiTest {

    private final OidcDiscoveryApi api = new OidcDiscoveryApi();
    ...
    public void getJWKSTest() throws Exception {
        InlineResponse2002 response = api.getJWKS();
     ...
     */
    @Test
    public void getOAuthAuthorizationServerMetadataTest() throws Exception {
        InlineResponse2001 response = api.getOAuthAuthorizationServerMetadata();
    ...
    public void getOpenIDConfigurationTest() throws Exception {
        InlineResponse200 response = api.getOpenIDConfiguration();
