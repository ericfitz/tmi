"""Status dashboard for the TMI dev environment (k3s and docker-desktop).

Reports the active kube context, in-cluster Deployments, server reachability,
and the optional OAuth stub. Pure parser deployment_readiness() is unit-tested.
"""
