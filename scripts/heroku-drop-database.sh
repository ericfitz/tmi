...
echo -e "  1. Run 'make reset-db-heroku' to drop and recreate schema"
echo -e "  2. Or restart the Heroku app to trigger GORM AutoMigrate"
echo -e "     heroku dyno:restart -a ${APP_NAME}"
echo ""
