...
func writeMigratedConfig(bootstrapSettings []config.MigratableSetting, outputPath string) error {
	...
	header := fmt.Sprintf("# TMI Configuration (bootstrap settings only)\n"+
		"# Generated by tmi-dbtool --import-config on %s\n"+
		"# Operational settings have been migrated to the database.\n"+
